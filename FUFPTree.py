...
class FUFPTree(object):
    """
    An FPFP tree which supports fast update of elements.
    """
    ...
    """=========================FUFP-tree specific code========================="""
    def pseudo_add(self, transaction):
        """
        Adds a transaction to the tree.
        """
        ...
        for item in transaction:
            ...
            if next_point:
                # There is already a node in this tree for the current
                # transaction item; Count is NOT incremented. This is
                # where it differs from the vanilla FPTree..
                pass
            else:
                # Create a new point and add it as a child of the point we're
                # currently looking at.
